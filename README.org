...
* Motivation
I started this project because I would like to use something similar to Chrome OS without Google Drive and fully opensource. 
* Getting Started
 You may experience some delay uring the moments where the module is validating the username and password with the server. It is reccommended to test in virtual machine prior to usage in a personal computer.
* Prerequisites
** Python 3
** pam_python
